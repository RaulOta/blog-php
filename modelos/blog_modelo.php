...
Class ModeloBlog{
    ...
    static public function mdlMostrarOpiniones($tabla1, $tabla2, $item, $valor){
        ...
        $tabla2 ON $tabla1.id_adm = $tabla2.id WHERE $item = :$item");
    ...
    static public function mdlEnviarOpinion($tabla, $datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_art, nombre_opinion, correo_opinion, foto_opinion, contenido_opinion, fecha_opinion, id_adm) 
        VALUES(:id_art, :nombre_opinion, :correo_opinion, :foto_opinion, :contenido_opinion, :fecha_opinion, :id_adm)");
    ...
    static public function mdlActualizarVista($tabla, $valor, $ruta){
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET vistas_articulo = :vistas_articulo WHERE
    ...
    static public function mdlArticulosDestacados($tabla, $item, $valor){
        ...
        if ($item != null && $valor != null) {
            ...
            $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla ORDER BY vistas_articulo DESC 
            LIMIT 3");
